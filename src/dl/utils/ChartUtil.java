...
public class ChartUtil {
  ...
  public static void main(String[] args) {
    ...
    // 生成水平单组柱状图
    pm.makeHorizontalBarChart();
    // 生成饼状图
    pm.makePieChart();
    // 生成折线图
    pm.makeLineAndShapeChart();
    System.out.println("Image creation completed!");
  }
   ...
   * 生成水平单组柱状图
   */
  public void makeHorizontalBarChart() {
    double[][] data = new double[][] {{672, 766, 223, 540, 126}};
    String[] rowKeys = {"苹果"};
    String[] columnKeys = {"北京", "上海", "广州", "成都", "深圳"};
    CategoryDataset dataSet = getBarData(data, rowKeys, columnKeys);
    createHorizontalBarChart(dataSet, "x坐标", "y坐标", "柱状图", "horizontalBar.png");
  }
  ...
  public void makePieChart() {
    double[] data = {9, 91};
    String[] keys = {"失败率", "成功率"};
    PieDataset dataSet = getDataPieSetByUtil(data, keys);
    createValidityComparePieChar(dataSet, "饼状图", "pie.png", keys);
  }
  ...
  public void makeLineAndShapeChart() {
    ...
    String[] columnKeys = {"北京", "上海", "广州", "成都", "深圳"};
    CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
    createTimeXYChar(dataset, "x坐标", "y坐标", "折线图", "lineAndShap.png");
  }
  ...
  public String createBarChart(CategoryDataset dataset, String xName, String yName, String chartTitle,
    ...
    try {
      ChartUtilities.writeChartAsPNG(getCharOutputSteam(CHART_PATH, charName), chart, 864, 237, true, 10);
    } catch (Exception e) {
      e.printStackTrace();
    }
   ...
   * @return
   */
  public String createValidityComparePieChar(PieDataset dataset, String chartTitle, String charName, String[] pieKeys) {
   ...
   * @return
   */
  public String createTimeXYChar(CategoryDataset xyDataset, String x, String y, String chartTitle, String charName) {

    JFreeChart chart = ChartFactory.createLineChart(chartTitle, x, y, xyDataset, PlotOrientation.VERTICAL, true, true,
        false);
  ...
  /**
   * 创建char输出流 （判断文件夹是否存在，如果不存在则新建）
   * @param chartPath path
   * @param charName name
   * @return FileOutputStream
   */
  private FileOutputStream getCharOutputSteam(String chartPath, String charName) {
    ...
    try {
      chartOutputStream = new FileOutputStream(CHART_PATH + charName);
    } catch (FileNotFoundException e) {
      e.printStackTrace();
    }
    return chartOutputStream;
  }
}
